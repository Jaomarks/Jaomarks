...
| 4 | Avaliações e notas | Novo endpoint de submissão/nota + tela de exercício real. Inclui também estágio obrigatório/horas complementares (aluno manda relatório + comprovante, coordenador aprova quantidade de semanas) — decisão do cliente: entra nesta etapa em vez de etapa própria | Etapa 2 |
...
nos dois repos, achados corrigidos). Decisão do cliente: estágio
obrigatório/horas complementares (seção 5-ter) entra na Etapa 4 junto
com avaliações/notas, em vez de virar etapa própria — construção da
Etapa 4 começando agora.

**Pendência que ficou pra trás na Etapa 3, não esquecer**: a sequência
